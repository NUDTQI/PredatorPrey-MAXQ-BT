...
{
	k_NODE_ActionNode = 0,
	k_NODE_SelectorNode = 1,
	k_NODE_SequenceNode = 2,
	k_NODE_ParalleNode = 3,
	k_NODE_LoopNode = 4,
};
...
public:
	...
	BevNode* oGetLastActiveNode();
	void SetActiveNode(BevNode* _o_Node);
	const char* GetDebugName() const;

	virtual CoreNodeType GetNodeType(){return CoreNodeType::k_NODE_ActionNode;}
	BevNode* GetParentNode(){return mo_ParentNode;}
	BevRunningStatus myStatus;
	bool m_bFire;
	//int durationCount;
...
public:
	...
	virtual void _DoTransition(const BevNodeInputParam& input);
	virtual BevRunningStatus _DoTick(const BevNodeInputParam& input, BevNodeOutputParam& output);
	virtual CoreNodeType GetNodeType(){return CoreNodeType::k_NODE_SelectorNode;}
...
public:
	...
	virtual void _DoTransition(const BevNodeInputParam& input);
	virtual BevRunningStatus _DoTick(const BevNodeInputParam& input, BevNodeOutputParam& output);
	virtual CoreNodeType GetNodeType(){return CoreNodeType::k_NODE_SequenceNode;}
...
public:
	...
	virtual CoreNodeType GetNodeType(){return CoreNodeType::k_NODE_ParalleNode;}
...
public:
	...
	virtual void _DoTransition(const BevNodeInputParam& input);
	virtual BevRunningStatus _DoTick(const BevNodeInputParam& input, BevNodeOutputParam& output);
	virtual CoreNodeType GetNodeType(){return CoreNodeType::k_NODE_LoopNode;}
